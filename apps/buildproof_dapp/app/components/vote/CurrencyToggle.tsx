import { Input, Switch } from '@0xintuition/buildproof_ui'
    ...
    <div className="flex items-center gap-14">
      <div className="flex-shrink-0 flex items-center gap-2 border border-white/20 rounded-lg p-4 min-w-[400px]">
        ...
        <div className="flex-shrink-0 flex items-center gap-2 bg-white/10 px-3 py-1 rounded-lg border border-white/10">
          <span
            className={`text-sm ${currency === 'ETH' ? 'text-primary font-bold' : 'text-white/60'}`}
          >
            ETH
          </span>
          <Switch
          ...
          />
          <span
            className={`text-sm ${currency === '$' ? 'text-accent font-bold' : 'text-white/60'}`}
          >
            USD
          </span>
        </div>
